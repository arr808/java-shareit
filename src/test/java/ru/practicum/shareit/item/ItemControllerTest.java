...
public class ItemControllerTest {
    ...
    public void shouldReturnSearchedItems() throws Exception {
        ...
        mvc.perform(get(QUERY + "/search?text=name"))
                .andExpect(status().isOk())
                .andExpect(content().json(mapper.writeValueAsString(List.of(itemDto))));
    }
    ...
    @Test
    public void shouldThrowExceptionAddItemWhenNameBlank() throws Exception {
        ItemDto noIdItemDto = ItemDto.builder()
                .name("")
                .description("desc")
                .available(true)
    ...
    @Test
    public void shouldThrowExceptionAddItemWhenDescriptionBlank() throws Exception {
        ItemDto noIdItemDto = ItemDto.builder()
                .name("name")
                .description("")
                .available(true)
    ...
    @Test
    public void shouldThrowExceptionAddItemWhenAvailableNull() throws Exception {
        ItemDto noIdItemDto = ItemDto.builder()
                .name("name")
                .description("desc")
                .build();
    ...
    @Test
    public void shouldThrowExceptionAddCommentWhenTextBlank() throws Exception {
        CommentDto noIdCommentDto = CommentDto.builder()
                .text("")
                .authorName("name")
                .created(timestamp)
